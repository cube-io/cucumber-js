...
//Issues might appear when handling _danish_ SBEs because of danish letters. Needs to be tested.
...
var TeamcityFormatter = function(options) {
    ...
    self.handleAfterFeatureEvent = function handleAfterFeatureEvent(event, callback) {
        ...
        self.writeToTeamcity("progressMessage", "Finished feature: " + feature_name);
        callback();
    };
    ...
    self.formatForTeamcity = function write(messagetype, args) {
        ...
        } else { //only ##teamcity[<messagename> <value>]    
            output += "'" + args + "'" + " ";
        }
